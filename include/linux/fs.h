...
extern int vfs_create2(struct vfsmount *, struct inode *, struct dentry *, int, struct nameidata *);
extern int vfs_mkdir(struct inode *, struct dentry *, int);
extern int vfs_mkdir2(struct vfsmount *, struct inode *, struct dentry *, int);
extern int vfs_mknod(struct inode *, struct dentry *, int, dev_t);
extern int vfs_mknod2(struct vfsmount *, struct inode *, struct dentry *, int, dev_t);
...
struct super_operations {
	...
	int (*show_options2)(struct seq_file *, struct vfsmount *);
